...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { cpf: @aluno.cpf, data_nascimento: @aluno.data_nascimento, nome: @aluno.nome, phone: @aluno.phone, rg: @aluno.rg } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { cpf: @aluno.cpf, data_nascimento: @aluno.data_nascimento, nome: @aluno.nome, phone: @aluno.phone, rg: @aluno.rg } }
