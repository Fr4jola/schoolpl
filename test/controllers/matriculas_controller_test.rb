...
class MatriculasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create matricula" do
    assert_difference('Matricula.count') do
      post matriculas_url, params: { matricula: { aluno_id: @matricula.aluno_id, ano: @matricula.ano, ativo: @matricula.ativo, curso_id: @matricula.curso_id, data_matricula: @matricula.data_matricula, pago: @matricula.pago } }
    end
  ...
  test "should update matricula" do
    patch matricula_url(@matricula), params: { matricula: { aluno_id: @matricula.aluno_id, ano: @matricula.ano, ativo: @matricula.ativo, curso_id: @matricula.curso_id, data_matricula: @matricula.data_matricula, pago: @matricula.pago } }
