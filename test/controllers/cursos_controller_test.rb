...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { nome: @curso.nome, periodo: @curso.periodo, valor_inscricao: @curso.valor_inscricao } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { nome: @curso.nome, periodo: @curso.periodo, valor_inscricao: @curso.valor_inscricao } }
